      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-4">
          ...
          <div className="flex justify-between items-center">
            <Link href="/auth?modal=forgot-password" className="text-sm text-primary hover:underline">
              Forgot password?
            </Link>
            <Link href="/auth?modal=signup" className="text-sm text-primary hover:underline">
